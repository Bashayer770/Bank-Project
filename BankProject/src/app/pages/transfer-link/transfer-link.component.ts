...
@Component({
  ...
  imports: [CurrencyPipe, ArrowsvgComponent, ArrowsvgComponent, CommonModule, ToastComponent],
...
return "test"
  ...
  Confirm() {
    ...
    this.transactionService.transfer({username: <string>this.userName, amount: <number>this.amount}).subscribe(response=>{
  ...
  constructor(private route: ActivatedRoute, private router: Router, private transactionService: TransactionService, private userService:UsersService) {
    ...
    this.route.queryParamMap.subscribe(params => {
      ...
      else
      {
        ...
        console.log(`Would you like to transfer ${this.amount} KD to ${this.userName}?`)
